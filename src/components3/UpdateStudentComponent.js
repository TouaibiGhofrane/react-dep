...
class UpdateStudentComponent extends Component {
    ...
    componentDidMount(){
        StudentService.getEtudiantById(this.state.id).then( (res) =>{
            let etd = res.data;
            this.setState({ cin: etd.cin,
                firstName: etd.firstName,
                lastName: etd.lastName
    ...
    updateEtudiant = (e) => {
        e.preventDefault();
        let etd = {cin: this.state.cin,firstName: this.state.firstName, lastName: this.state.lastName};
        console.log('etd => ' + JSON.stringify(etd));
        console.log('id => ' + JSON.stringify(this.state.id));
        StudentService.updateEnseignant(etd, this.state.id).then( res => {
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    ...
                                    <div className = "form-group">
                                        ...
                                        <button className="btn btn-success" onClick={this.updateEtudiant}>Save</button>
